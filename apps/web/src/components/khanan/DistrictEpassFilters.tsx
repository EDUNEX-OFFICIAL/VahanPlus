...
export function DistrictEpassFilters({
  ...
  const [draft, setDraft] = useState<DistrictFilterDraft>(values);
    ...
    <div className="space-y-3">
      <div className="flex flex-wrap items-center gap-3">
        <div className="relative" ref={panelRef}>
          ...
          {open ? (
            <Card className="absolute left-0 top-full z-30 mt-2 w-[min(100vw-2rem,420px)] space-y-4 p-4 shadow-xl">
              <div>
              ...
              <div>
                ...
                <div className="mt-2 max-h-36 space-y-2 overflow-y-auto rounded-lg border border-border-default bg-surface-deep p-3">
              ...
              {draft.dateMode === 'range' ? (
                <div className="grid grid-cols-2 gap-3">
                  <div>
                    <label className="text-xs uppercase tracking-wider text-text-secondary" htmlFor="date-from">
                      From
                    </label>
                    <input
                      id="date-from"
                  ...
                  <div>
                    <label className="text-xs uppercase tracking-wider text-text-secondary" htmlFor="date-to">
                      To
                    </label>
                    <input
                      id="date-to"
              ...
              <div>
                <label className="text-xs uppercase tracking-wider text-text-secondary" htmlFor="report-date">
                  Report date
                </label>
                <select
                  id="report-date"
