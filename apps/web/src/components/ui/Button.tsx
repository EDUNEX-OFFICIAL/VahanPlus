...
const variants: Record<Variant, string> = {
  ...
  secondary: 'bg-slate-700/20 border-slate-600/50 text-slate-200 hover:bg-slate-700/30',
  ghost: 'bg-transparent border-transparent text-indigo-400 hover:text-indigo-300',
  destructive: 'bg-red-500/15 border-red-500/50 text-red-100 hover:bg-red-500/25 active:scale-95',
  warning:
