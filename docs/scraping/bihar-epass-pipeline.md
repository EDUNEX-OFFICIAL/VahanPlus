...
Use **Pause scraping** before clearing a bad queue; use **Backfill vehicle status** with a limit (default 100, max 500).
...
2. Run fix script or `queue.obliterate` / remove waiting jobs.
